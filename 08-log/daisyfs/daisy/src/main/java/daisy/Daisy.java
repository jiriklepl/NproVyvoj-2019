...
class DaisyDisk {
    ...
    static synchronized void readi(long inodenum, Inode i) {
    ...
    static synchronized void writei(Inode i) { 
    ...
    static synchronized void writeAllocBit(long blockno, boolean bit) {
